...
public class ProfileUpdateResource extends BaseResource {
    private final static Logger log = LoggerFactory.getLogger(ProfileUpdateResource.class);
    ...
    static class ProfileUpdate {
        ...
        @XmlElement
        public final String msg = "Your profile information has been updated " + "successfully.";
    }
     ...
     */
    protected void validateParams(final String firstName, final String lastName, final String login,
     ...
     *            the updated email address for the user
     * @param pass
     *            the updated password for the user, possibly null if the password should not be updated
     * 
     * @return the profile update response
     */
    @POST
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public ProfileUpdate update(@Context final SecurityContext security, @Context final Config config,
            ...
            @FormParam("login") final String login, @FormParam("email") final String email,
