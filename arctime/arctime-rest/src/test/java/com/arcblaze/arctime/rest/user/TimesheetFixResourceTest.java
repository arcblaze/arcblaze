...
public class TimesheetFixResourceTest {
     ...
     */
    @Test
    public void testTimesheetNotCompleted() throws DatabaseException, ParseException, HolidayConfigurationException {
        final Config config = new Config();
        try (final TestDatabase testDatabase = new TestDatabase()) {
            testDatabase.load("hsqldb/arctime-db.sql");
            final ArcTimeDaoFactory daoFactory = testDatabase.getDaoFactory();
            ...
            final TimesheetFixResource resource = new TimesheetFixResource();
            final FixResponse response = resource.fix(security, config, daoFactory, timer, timesheet.getId());
     ...
     */
    @Test
    public void testTimesheetCompleted() throws DatabaseException, ParseException, HolidayConfigurationException {
        final Config config = new Config();
        try (final TestDatabase testDatabase = new TestDatabase()) {
            testDatabase.load("hsqldb/arctime-db.sql");
            final ArcTimeDaoFactory daoFactory = testDatabase.getDaoFactory();
