...
public class UserResourceTest {
    ...
    public void testGet() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final UserResource resource = new UserResource();
            final User response = resource.get(securityContext, config, daoFactory, timer, user.getId());
    ...
    /**
     * Test how the resource responds to retrieving all users when none are available.
     * 
     * @throws DatabaseException
     *             if there is a database problem
     */
    ...
    public void testAllNoneAvailable() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final UserResource resource = new UserResource();
            final AllResponse response = resource.all(securityContext, config, daoFactory, timer, null, true, null,
                    null);
    ...
    public void testAll() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final UserResource resource = new UserResource();
            AllResponse response = resource.all(securityContext, config, daoFactory, timer, null, true, null, null);
            ...
            response = resource.all(securityContext, config, daoFactory, timer, null, true, 2, 0);
            ...
            response = resource.all(securityContext, config, daoFactory, timer, null, true, 1, 0);
            ...
            response = resource.all(securityContext, config, daoFactory, timer, null, true, 1, 1);
            ...
            response = resource.all(securityContext, config, daoFactory, timer, "email1", true, null, null);
    ...
    /**
     * Test how the resource responds to retrieving all users, with the inactive included parameter specified.
     * 
     * @throws DatabaseException
     *             if there is a database problem
     */
    ...
    public void testAllWithIncludeInactive() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            assertNotNull(response.users);
            assertEquals(2, response.users.size());
            assertTrue(response.users.contains(active));
            assertTrue(response.users.contains(inactive));

            response = resource.all(securityContext, config, daoFactory, timer, null, false, null, null);
            ...
            response = resource.all(securityContext, config, daoFactory, timer, "active", false, null, null);
            ...
            response = resource.all(securityContext, config, daoFactory, timer, "active", true, null, null);
    ...
    public void testAdd() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final UserResource resource = new UserResource();
            final AddResponse response = resource.add(securityContext, config, daoFactory, timer, user);
            ...
            assertEquals(1, daoFactory.getUserDao().getAll(company.getId(), true, null, null).size());
        }
    }
    ...
    public void testActivate() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final UserResource resource = new UserResource();
            resource.activate(securityContext, config, daoFactory, timer, new IdSet(user.getId()));
    ...
    public void testDectivate() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final UserResource resource = new UserResource();
            resource.deactivate(securityContext, config, daoFactory, timer, new IdSet(user.getId()));
    ...
    public void testUpdate() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final UserResource resource = new UserResource();
            final UpdateResponse response = resource.update(securityContext, config, daoFactory, timer, user);
    ...
    public void testDelete() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final UserResource resource = new UserResource();
            resource.delete(securityContext, config, daoFactory, timer, new IdSet(user.getId()));

            assertEquals(0, daoFactory.getUserDao().getAll(company.getId(), true, null, null).size());
        }
    }
}
