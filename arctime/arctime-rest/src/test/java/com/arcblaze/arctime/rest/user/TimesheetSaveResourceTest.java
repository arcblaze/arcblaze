...
public class TimesheetSaveResourceTest {
    ...
    public void testInvalidData() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final TimesheetSaveResource resource = new TimesheetSaveResource();
            resource.save(security, config, daoFactory, timer, timesheet.getId(), "data");
        }
    }
    ...
    public void testEmptyData() throws DatabaseException, HolidayConfigurationException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final TimesheetSaveResource resource = new TimesheetSaveResource();
            resource.save(security, config, daoFactory, timer, timesheet.getId(), "");
     ...
     */
    @Test
    public void testSaveDataIntoTimesheet() throws DatabaseException, HolidayConfigurationException {
        final Config config = new Config();
        try (final TestDatabase testDatabase = new TestDatabase()) {
            testDatabase.load("hsqldb/arctime-db.sql");
            final ArcTimeDaoFactory daoFactory = testDatabase.getDaoFactory();
            ...
            final TimesheetSaveResource resource = new TimesheetSaveResource();
            resource.save(security, config, daoFactory, timer, timesheet.getId(), timesheetData);
