...
public class TimesheetPreviousResourceTest {
    ...
    public void testInvalidDate() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            resource.previous(security, config, daoFactory, timer, "abcd");
        }
    }
    ...
    public void testNoPayPeriodsAvailable() throws DatabaseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final TimesheetPreviousResource resource = new TimesheetPreviousResource();
            resource.previous(security, config, daoFactory, timer, "20140101");
        }
    }
    ...
    public void testNoTimesheetsAvailable() throws DatabaseException, ParseException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final TimesheetPreviousResource resource = new TimesheetPreviousResource();
            final PreviousResponse response = resource.previous(security, config, daoFactory, timer, "20140101");
            ...
            assertEquals("20131225", DateFormatUtils.format(ts.getPayPeriod().getBegin(), "yyyyMMdd"));
            assertEquals("20131231", DateFormatUtils.format(ts.getPayPeriod().getEnd(), "yyyyMMdd"));
    ...
    public void testTimesheetWithHolidays() throws DatabaseException, ParseException, HolidayConfigurationException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final Holiday holiday = new Holiday().setCompanyId(company.getId()).setDescription("holiday")
                    .setConfig(DateFormatUtils.format(DateUtils.addDays(payPeriod.getBegin(), -1), "MMM d"));
    ...
    public void testTimesheetWithUsers() throws DatabaseException, ParseException, HolidayConfigurationException {
        ...
        try (final TestDatabase testDatabase = new TestDatabase()) {
            ...
            final TimesheetPreviousResource resource = new TimesheetPreviousResource();
            final PreviousResponse response = resource.previous(security, config, daoFactory, timer,
                    DateFormatUtils.format(payPeriod.getNext().getBegin(), "yyyyMMdd"));
