...
public class PayPeriodTest {
    ...
    public void testContainsDate() throws ParseException {
        final PayPeriod p = new PayPeriod().setType(PayPeriodType.WEEKLY).setCompanyId(1)
     ...
     */
    @Test
    public void testContainsHoliday() throws ParseException, HolidayConfigurationException {
        final PayPeriod p1 = new PayPeriod().setType(PayPeriodType.WEEKLY).setCompanyId(1)
                .setBegin(DateUtils.parseDate("20140101", FMT)).setEnd(DateUtils.parseDate("20140107", FMT));
        final PayPeriod p2 = new PayPeriod().setType(PayPeriodType.MONTHLY).setCompanyId(1)
                .setBegin(DateUtils.parseDate("20140201", FMT)).setEnd(DateUtils.parseDate("20140228", FMT));

        final Holiday h1 = new Holiday().setConfig("January 1st Observance");
        final Holiday h2 = new Holiday().setConfig("1st Thursday in January");
        final Holiday h3 = new Holiday().setConfig("2nd Thursday in January");
        final Holiday h4 = new Holiday().setConfig("February 1st");
        final Holiday h5 = new Holiday().setConfig("February 1st Observance");
    ...
    public void testGetPreviousWeekly() throws ParseException {
        ...
        final PayPeriod n1 = p.getPrevious();
        ...
        final PayPeriod n2 = n1.getPrevious();
        ...
        final PayPeriod n3 = n2.getPrevious();
        ...
        final PayPeriod n4 = n3.getPrevious();
    ...
    public void testGetPreviousBiWeekly() throws ParseException {
        final PayPeriod p = new PayPeriod().setType(PayPeriodType.BI_WEEKLY).setCompanyId(1)
                .setBegin(DateUtils.parseDate("20140101", FMT)).setEnd(DateUtils.parseDate("20140114", FMT));
    ...
    public void testGetPreviousSemiMonthly() throws ParseException {
        final PayPeriod p = new PayPeriod().setType(PayPeriodType.SEMI_MONTHLY).setCompanyId(1)
                .setBegin(DateUtils.parseDate("20140101", FMT)).setEnd(DateUtils.parseDate("20140115", FMT));
    ...
    public void testGetPreviousSemiMonthlyMidMonth() throws ParseException {
        final PayPeriod p = new PayPeriod().setType(PayPeriodType.SEMI_MONTHLY).setCompanyId(1)
                .setBegin(DateUtils.parseDate("20140110", FMT)).setEnd(DateUtils.parseDate("20140125", FMT));
    ...
    public void testGetPreviousMonthly() throws ParseException {
        final PayPeriod p = new PayPeriod().setType(PayPeriodType.MONTHLY).setCompanyId(1)
                .setBegin(DateUtils.parseDate("20140101", FMT)).setEnd(DateUtils.parseDate("20140131", FMT));
    ...
    public void testGetPreviousMonthlyMidMonth() throws ParseException {
        final PayPeriod p = new PayPeriod().setType(PayPeriodType.MONTHLY).setCompanyId(1)
                .setBegin(DateUtils.parseDate("20140115", FMT)).setEnd(DateUtils.parseDate("20140214", FMT));
