...
public interface PayPeriodDao {
	 ...
	 */
	boolean exists(final Integer companyId, final Date begin)
			throws DatabaseException;
	 ...
	 *             if there is a problem communicating with the database
	 */
	PayPeriod get(final Integer companyId, final Date begin)
			throws DatabaseException;
	 ...
	 *             if there is a problem communicating with the database
	 */
	PayPeriod getContaining(final Integer companyId, final Date day)
			throws DatabaseException;
