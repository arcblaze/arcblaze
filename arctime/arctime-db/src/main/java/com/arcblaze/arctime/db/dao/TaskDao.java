...
public interface TaskDao {
    /**
     * @param companyId
     *            the unique id of the company for which the task will be retrieved
     * @param taskId
     ...
     */
    Task get(final Integer companyId, final Integer taskId) throws DatabaseException;
     ...
     * 
     * @return all available tasks for the user during the provided pay period, possibly empty but never {@code null}
     * 
     * @throws IllegalArgumentException
     ...
     *             if there is a problem communicating with the database
     */
    Set<Task> getForPayPeriod(final Integer userId, final PayPeriod payPeriod) throws DatabaseException;

    /**
     * @param userId
     *            the unique id of the user for which tasks will be retrieved
     * @param day
     *            the day for which task assignments must be valid, may be {@code null} if date is not important
     * @param includeAdmin
     *            whether administrative tasks should be included
     * 
     * @return all available tasks for the user on the given day, possibly empty but never {@code null}
     * 
     * @throws IllegalArgumentException
     ...
     *             if there is a problem communicating with the database
     */
    Set<Task> getForUser(final Integer userId, final Date day, final boolean includeAdmin) throws DatabaseException;
     ...
     *             if there is a problem communicating with the database
     */
    Set<Task> getAll(final Integer companyId, final boolean includeAdmin, final boolean includeInactive,
     ...
     *             if there is a problem communicating with the database
     */
    int activate(final Integer companyId, final Integer... taskIds) throws DatabaseException;
     ...
     *             if there is a problem communicating with the database
     */
    int activate(final Integer companyId, final Collection<Integer> taskIds) throws DatabaseException;

    /**
     * @param companyId
     *            the unique id of the company for which tasks will be deactivated
     * @param taskIds
     ...
     *             if there is a problem communicating with the database
     */
    int deactivate(final Integer companyId, final Integer... taskIds) throws DatabaseException;
     ...
     *             if there is a problem communicating with the database
     */
    int deactivate(final Integer companyId, final Collection<Integer> taskIds) throws DatabaseException;
     ...
     *             if there is a problem communicating with the database
     */
    int delete(final Integer companyId, final Integer... taskIds) throws DatabaseException;
     ...
     *             if there is a problem communicating with the database
     */
    int delete(final Integer companyId, final Collection<Integer> taskIds) throws DatabaseException;
}
