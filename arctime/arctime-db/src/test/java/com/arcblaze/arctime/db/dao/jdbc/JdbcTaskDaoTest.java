...
public class JdbcTaskDaoTest {
    ...
    public void dbIntegrationTests() throws DatabaseException {
        try (final TestDatabase database = new TestDatabase()) {
            ...
            Set<Task> tasks = taskDao.getAll(company.getId(), true, true, null, null);
            assertNotNull(tasks);
            ...
            Set<Task> getAllTasks = taskDao.getAll(company.getId(), true, true, null, null);
            ...
            getAllTasks = taskDao.getAll(company.getId(), true, true, 5, 0);
            assertNotNull(getAllTasks);
            assertEquals(3, getAllTasks.size());
            assertTrue(getAllTasks.contains(task));
            assertTrue(getAllTasks.contains(admin));
            ...
            getAllTasks = taskDao.getAll(company.getId(), true, true, 1, 1);
            assertNotNull(getAllTasks);
            assertEquals(1, getAllTasks.size());
            assertTrue(getAllTasks.contains(admin));

            getAllTasks = taskDao.getAll(company.getId(), false, true, null, null);
            assertNotNull(getAllTasks);
            assertEquals(2, getAllTasks.size());
            assertTrue(getAllTasks.contains(task));
            assertTrue(getAllTasks.contains(inactive));

            getAllTasks = taskDao.getAll(company.getId(), true, false, null, null);
            assertNotNull(getAllTasks);
            assertEquals(2, getAllTasks.size());
            assertTrue(getAllTasks.contains(task));
            assertTrue(getAllTasks.contains(admin));
            ...
            getAllTasks = taskDao.getAll(company.getId(), false, false, null, null);
            assertNotNull(getAllTasks);
            assertEquals(0, getAllTasks.size());

            getAllTasks = taskDao.getAll(company.getId(), true, true, null, null);
            assertNotNull(getAllTasks);
            assertEquals(2, getAllTasks.size());
            assertTrue(getAllTasks.contains(admin));
            assertTrue(getAllTasks.contains(inactive));
            ...
            assignment.setBegin(DateUtils.truncate(DateUtils.addDays(new Date(), -10), Calendar.DATE));
            assignment.setEnd(DateUtils.truncate(DateUtils.addDays(new Date(), 10), Calendar.DATE));
            assignmentDao.add(assignment);

            Set<Task> assignedTasks = taskDao.getForUser(user.getId(), null, true);
            ...
            assignedTasks = taskDao.getForUser(user.getId(), DateUtils.addDays(new Date(), -15), true);
            assertNotNull(assignedTasks);
            assertEquals(1, assignedTasks.size());
            assertTrue(assignedTasks.contains(adminTask));

            assignedTasks = taskDao.getForUser(user.getId(), DateUtils.addDays(new Date(), -15), false);
            assertNotNull(assignedTasks);
