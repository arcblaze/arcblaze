...
/**
 * Responsible for sending emails to the system administrator as part of the contact-us page on the web site.
 */
public class ContactUsMailSender extends MailSender {
     ...
     */
    public ContactUsMailSender(final Config config, final String system, final String name, final String email,
