...
public abstract class MailSender {
     ...
     */
    protected InternetAddress getAdminAddress() throws UnsupportedEncodingException {
    ...
    /**
     * @return an {@link InternetAddress} representing the generic system email sending account
     * 
     * @throws UnsupportedEncodingException
     *             if there is an encoding issue
     */
    protected InternetAddress getSenderAddress() throws UnsupportedEncodingException {
    ...
    /**
     * @param user
     *            the {@link User} for which the corresponding internet address will be created
     * 
     ...
     *             if there is an encoding issue
     */
    protected InternetAddress getAddress(final User user) throws UnsupportedEncodingException {
    ...
    /**
     * Used to fully populate a {@link MimeMessage} in preparation for being sent.
     * 
     * @param message
     *            the {@link MimeMessage} to be populated with from, to, subject, and message information
     * 
     ...
     *             if there is an encoding issue
     */
    public abstract void populate(final MimeMessage message) throws MessagingException, UnsupportedEncodingException;
