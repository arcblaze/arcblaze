...
/**
 * Responsible for sending emails to system administrators in the event an error occurs on the web site.
 */
public class SystemErrorMailSender extends MailSender {
     ...
     */
    public SystemErrorMailSender(final Config config, final User user, final Throwable problem) {
        super(config);
