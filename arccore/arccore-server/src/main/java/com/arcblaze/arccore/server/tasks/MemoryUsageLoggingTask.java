...
public class MemoryUsageLoggingTask extends BackgroundTask {
    private final static Logger log = LoggerFactory.getLogger(MemoryUsageLoggingTask.class);
     ...
     */
    public MemoryUsageLoggingTask(final Config config, final MetricRegistry metricRegistry,
    ...
    public void process() throws BackgroundTaskException {
        ...
        log.info(String.format("Memory Usage: Heap %.2f%% of %.0fM, " + "Non Heap %.2f%% of %.0fM", heapPctUsed,
                maxHeapMegs, nonHeapPctUsed, maxNonHeapMegs));
    }
}
