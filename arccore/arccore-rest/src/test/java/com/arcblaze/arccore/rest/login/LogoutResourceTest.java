...
public class LogoutResourceTest {
    ...
    public void testLogout() throws URISyntaxException, ServletException {
        ...
        Mockito.when(uriInfo.getBaseUri()).thenReturn(new URI("http://localhost/rest/logout"));
        ...
        final Response response = resource.logout(securityContext, request, uriInfo, config, timer);
