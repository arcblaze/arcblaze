...
public class ContactUsResourceTest {
    ...
    public void testNullName() {
        ...
        resource.send(config, timer, null, "email@somewhere.com", "HELP", "message");
    }
    ...
    public void testNullType() {
        ...
        final ContactUsResource resource = new ContactUsResource();
        resource.send(config, timer, "Name", "email@somewhere.com", null, "message");
    }
    ...
    public void testNullMessage() {
        ...
        final ContactUsResource resource = new ContactUsResource();
        resource.send(config, timer, "Name", "email@somewhere.com", "HELP", null);
    }
    ...
    public void testValidSend() {
        ...
        final ContactUsMailSender mockMailSender = Mockito.mock(ContactUsMailSender.class);

        final ContactUsResource resource = new ContactUsResource(mockMailSender);
        resource.send(config, timer, "Name", "email@somewhere.com", "HELP", "message");
    }
}
