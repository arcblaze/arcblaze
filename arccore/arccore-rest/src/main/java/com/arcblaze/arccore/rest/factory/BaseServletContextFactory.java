...
/**
 * The default implementation of a factory used to inject objects into our REST
 * resources, retrieving the object from the servlet context.
 * 
 * @param <T>
...
public abstract class BaseServletContextFactory<T> extends BaseFactory<T> {
	 ...
	 * @param attributeName
	 *            the name of the request attribute from which this factory will
	 *            retrieve objects
	 */
	public BaseServletContextFactory(final ServletContext servletContext,
