...
/**
 * Provides access to {@link HealthCheckRegistry} objects within the REST
 * resource classes.
 */
public class HealthCheckRegistryFactory extends
		BaseServletContextFactory<HealthCheckRegistry> {
	/**
	 * @param servletContext
	 *            the servlet context from which the health check registry will
	 *            be retrieved
	 */
	...
	public static AbstractBinder getBinder() {
		return new AbstractBinder() {
			...
			protected void configure() {
				bindFactory(HealthCheckRegistryFactory.class).to(
