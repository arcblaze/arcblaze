...
/**
 * Provides access to {@link Timer} objects within the REST resource classes,
 * pre-configured with the REST end-point associated with the request.
 */
public class TimerFactory extends BaseFactory<Timer> {
	private final static Logger log = LoggerFactory
			.getLogger(TimerFactory.class);
	 ...
	 */
	public TimerFactory(final @Context HttpServletRequest request,
			final @Context MetricRegistry metricRegistry) {
