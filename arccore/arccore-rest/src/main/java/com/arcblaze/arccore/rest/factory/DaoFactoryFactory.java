...
/**
 * Provides access to {@link DaoFactory} objects within the REST resource
 * classes.
 */
public class DaoFactoryFactory extends BaseServletContextFactory<DaoFactory> {
	...
	public final static String DAO_FACTORY_CONFIG = DaoFactoryFactory.class
			.getCanonicalName() + ".config";
