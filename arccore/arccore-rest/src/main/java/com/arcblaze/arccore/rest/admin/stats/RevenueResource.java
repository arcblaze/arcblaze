...
public class RevenueResource extends BaseResource {
    ...
    public String getRevenue(@Context final DaoFactory daoFactory, @Context final Timer timer,
        ...
        try (final Timer.Context timerContext = timer.time()) {
            ...
            final SortedMap<Date, BigDecimal> data = dao.getSumByMonth(begin, end);
