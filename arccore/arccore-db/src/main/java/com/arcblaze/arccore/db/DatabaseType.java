...
/**
 * Describes the supported types of databases that can be used as a back-end in this system.
 */
public enum DatabaseType {
     ...
     * 
     * @return the identified {@link DatabaseType}, or {@code null} if the conversion fails
     */
