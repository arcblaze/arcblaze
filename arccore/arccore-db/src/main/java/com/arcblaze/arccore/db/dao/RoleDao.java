...
public interface RoleDao {
     ...
     * 
     * @return the identified roles for the provided user, possibly empty but never {@code null}
     * 
    ...
    /**
     * @param users
     *            the {@link User} objects for which roles will be retrieved and inserted
     * 
     * @throws IllegalArgumentException
     ...
     *             if there is a problem communicating with the database
     */
    int add(final Integer userId, final Collection<Role> roles) throws DatabaseException;
     ...
     *             if there is a problem communicating with the database
     */
    int delete(final Integer userId, final Role... roles) throws DatabaseException;
     ...
     *             if there is a problem communicating with the database
     */
    int delete(final Integer userId, final Collection<Role> roles) throws DatabaseException;
