...
public enum TransactionType {
    ...
    /**
     * Attempt to convert the provided value into a {@link TransactionType} with more flexibility than what the
     * {@link #valueOf(String)} method provides.
     * 
     * @param value
     *            the value to attempt conversion into a {@link TransactionType}
     * 
     * @return the identified {@link TransactionType}, or {@code null} if the conversion fails
     */
